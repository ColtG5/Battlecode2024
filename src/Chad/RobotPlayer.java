...
import Chad.Utility;
import Chad.specialists.Defender;
import Chad.specialists.Flagrunner;
import Chad.specialists.Scout;
...
//    public static final int FLAGRUNNER_BUILDER_GROUP_3_ID = INITIAL_GROUP_3_LEADER_ID + 1;
    ...
    public static Chad.Utility.CoolRobotInfo[] coolRobotInfoArray = new Chad.Utility.CoolRobotInfo[50];
...
//    static final int flagRunnerGroupIndexingStart = 53;
    ...
    public static void run(RobotController rc) throws Exception {
        ...
        Chad.Movement movement = new Movement(rc, lefty);
        Chad.Utility utility = new Chad.Utility(rc);
