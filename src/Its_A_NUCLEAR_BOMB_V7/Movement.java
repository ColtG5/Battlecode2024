...
public class Movement {
    ...
    public boolean smallMove(Direction dir) throws GameActionException {
        Direction lilLeft = dir.rotateLeft();
        Direction lilRight = dir.rotateRight();
        if (rc.canMove(dir) || rc.canFill(rc.getLocation().add(dir))) {
            ...
            return true;
        } else if (rc.canMove(lilLeft) || rc.canFill(rc.getLocation().add(lilLeft))) {
            if (rc.canFill(rc.getLocation().add(lilLeft))) rc.fill(rc.getLocation().add(lilLeft));
            if (rc.canMove(lilLeft)) rc.move(lilLeft);
            return true;
        } else if (rc.canMove(lilRight) || rc.canFill(rc.getLocation().add(lilRight))) {
            if (rc.canFill(rc.getLocation().add(lilRight))) rc.fill(rc.getLocation().add(lilRight));
            if (rc.canMove(lilRight)) rc.move(lilRight);
            return true;
        }
        return false;
    }
